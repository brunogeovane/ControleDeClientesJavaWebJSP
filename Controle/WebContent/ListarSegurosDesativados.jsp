...
table_chart</i>Seguros Desativados</h4>
<form action="sistema?logica=AtivarSeguro" method="post">
...
cancel_presentation
		...
		<%
			...
			for (Seguro c : seguros) {
				...
				out.println("<td><button type='submit' value='" + c.getIdSeguro() + "' name='idSeguro' class='btn btn-primary'>Ativar</button></td>");
				out.println("</tr>");
			}
		%>
	</table></form>
