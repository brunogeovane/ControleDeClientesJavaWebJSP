...
<br>
	<h3>Cadastro de Contas</h3><br>
<form action="sistema?logica=CriarConta" method="post">

<select name="tipoConta" class="form-control form-control-lg">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input name="saldo" type="text" class="form-control" placeholder="00.00">
		...
		<br> <p class="text-danger">Atenção por favor confirme o padrão número do Cliente abaixo:</p>
...
<br>		
		<center><input type="submit" class="btn btn-dark" value="Criar Conta"></center>
	</form>
</body>
</html>